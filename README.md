...
The project focuses on transforming raw financial features into interpretable, statistically validated, and production-ready trading patterns using leakage safe feature engineering, decision tree–based clustering, & rigorous multi-stage validation using renko dataset . The core philosophy of this project is robustness over complexity prioritizing explainability, out of sample reliability, & temporal stability rather than black-box performance.
...
## <img src="https://github.com/user-attachments/assets/8f09f616-c687-48a1-8a30-76dffda656b9" width="28" style="position: relative; top: 3px;"/> MODULE 2: MODEL TRAINING (DECISION TREE CLUSTERING) (Core)
